...
TESTS = [
    {
        ...
        "expanded_goal": "hur många bor i Hjo invånare befolkning folkmängd population inhabitants Hjo kommun antal personer statistik medborgare",
    ...
    },
    {
        ...
        "expanded_goal": "find latest news articles stories submissions top links today technology programming startup comments points",
    ...
    },
    {
        ...
        "expanded_goal": "download install Rust programming language rustup cargo version stable release getting started toolchain compiler",
    ...
    },
    {
        ...
        "expanded_goal": "find technology articles programming stories discussions links submissions tags categories software engineering web development",
    ...
    },
    {
        ...
        "expanded_goal": "find Python packages pip install search library module PyPI repository package index download latest version",
    ...
    },
    {
        ...
        "expanded_goal": "HTML elements reference tags attributes semantic markup heading paragraph div span link image form input table list",
    ...
    },
    {
        ...
        "expanded_goal": "search container images Docker Hub registry pull push repository official image base alpine ubuntu nginx postgres",
    ...
    },
    {
        ...
        "expanded_goal": "speed of light value 299792458 meters per second c constant electromagnetic vacuum physics exactly defined SI",
    ...
    },
    {
        ...
        "expanded_goal": "nyheter Tibro kommun senaste aktuellt händelser information kommunal beslut verksamhet invånare service",
    ...
    },
    {
        ...
        "expanded_goal": "Go packages modules Golang standard library documentation API reference import package search discover",
