...
fn test_cases() -> Vec<TestCase> {
    vec![
        TestCase {
            name: "Wikipedia Stockholm",
            url: "https://en.wikipedia.org/wiki/Stockholm",
            goal: "population of Stockholm",
            expected_keyword: "population",
            top_n: 10,
        },
        TestCase {
            name: "Hacker News",
        ...
        TestCase {
            name: "Crates.io",
            url: "https://crates.io",
            goal: "most downloaded Rust crates",
            expected_keyword: "crate",
            top_n: 10,
        },
        TestCase {
            name: "StackOverflow",
            url: "https://stackoverflow.com/questions",
            goal: "popular programming questions",
            expected_keyword: "question",
            top_n: 10,
        },
        TestCase {
            name: "Reuters",
        ...
        TestCase {
            name: "Wikipedia Rust PL",
            url: "https://en.wikipedia.org/wiki/Rust_(programming_language)",
            goal: "Rust programming language features",
            expected_keyword: "rust",
            top_n: 10,
        },
        TestCase {
            ...
            expected_keyword: "npm",
            top_n: 10,
        },
        TestCase {
            name: "Wikipedia AI",
            url: "https://en.wikipedia.org/wiki/Artificial_intelligence",
            goal: "definition of artificial intelligence",
            expected_keyword: "artificial",
            top_n: 10,
        },
        TestCase {
            name: "DuckDuckGo",
        ...
        TestCase {
            ...
            goal: "types of machine learning",
        ...
        TestCase {
            ...
            goal: "robots disallow rules",
            expected_keyword: "robot",
            top_n: 10,
        },
    ]
}
